...
exports.getMoviesByDifficulty = exports.getMovieByTitle = exports.getRandomMovie = exports.MOVIES = void 0;
exports.MOVIES = [
    // ---------- EASY ----------
    {
        id: "frozen",
...
// Helper functions
const getRandomMovie = (excludedIds = new Set(), difficulty) => {
    ...
    const availableMovies = filteredMovies.filter((movie) => !excludedIds.has(movie.id));
